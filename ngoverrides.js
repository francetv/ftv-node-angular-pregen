...
function registerModule(context, options) {
        ...
        function () {
            return {
                $get: function (serverRequestContext, $location) {
                    ...
                    var ret = function (
                        reqMethod, reqUrl, reqData, callback
                    ) {
                        var isJSONP = false;
                        ...
                        var key;
                        for (key in options.request.headers) {
                            request.headers[key] = options.request.headers[key];
                        }
